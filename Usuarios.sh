...
dialog --title "Lista de usuários" --textbox out 30 30
...
########################### Função Mudar a senhao #####################
function senhauser() {
clear

user=$(dialog --stdout							\
	      --inputbox "Digite o nome do usuário a ser modificado a senha:" 0 60)
...
#senha=$(dialog --stdout	--insecure					\
#	        --passwordbox  "Digite a nova senha do usuário:" 0 50)
#
#dialog --title " Confirmação"	\
#	--backtitle "Atenção"	\
#	--yesno "Você tem certeza que deseja alterar a senha do usuário "$user" ?" 7 60
